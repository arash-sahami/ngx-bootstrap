...
describe('Modals demo page test suite', () => {
  ...
  describe('Modals demo page test suite', () => {
    ...
    describe.only('Modal events', () => {
      ...
      const eventOnHideFired = 'event onHide is fired';
      const eventOnHiddenFired = 'event onHidden is fired';
      const demoHideDismissed = 'onHide event has been fired, dismissed by backdrop-click';
      const demoHiddenDismissed = 'onHidden event has been fired, dismissed by backdrop-click';
      ...
      it.only(`when user closes modal by click on the cross then should be messages "onHide event has been fired"
      and "onHidden event has been fired"`, () => {
        modals.clickByText(eventsModalsDemo, btnText);
        ...
        modals.isModalDemoContainsText(eventsModalsDemo, eventOnHideFired, 2);
        modals.isModalDemoContainsText(eventsModalsDemo, eventOnHiddenFired, 3);
      });
